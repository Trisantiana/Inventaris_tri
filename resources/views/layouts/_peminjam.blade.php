	...
	<nav class="navbar navbar-expand fixed-top bg-primary text-white">
		<div class="container text-white">
			...
			<div class="collapse navbar-collapse" id="navbar">
				...
				<ul class="navbar-nav mr-auto text-white" style="margin-left: 70%; float: right;">
					<li class="nav-item text-white">
						<a href="{{ route('peminjam.dataInven') }}" class="text-white" style="text-decoration: none; margin-top: 50px; margin-right:10px; ">Data Inventaris</a>
					</li>

					<li>
                            @if(Session::has('cart'))
                            <a href="{{ route('peminjam.borrow') }}" style="color: #fff;">
                            ...
                            @else
                            {{-- <a href="{{ route('peminjam.dataInven') }}" style="color: #fff; text-decoration: none;">
                                Tambah Peminjaman
                            </a> --}}
                            @endif
                        </li>
